# Civically Ratings Extension

This is a Discourse plugin built for [Civically](https://civically.io). It is an extension of the [Discourse Ratings plugin](https://meta.discourse.org/t/topic-ratings-plugin/39578).
